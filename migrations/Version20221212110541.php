 ...
 */
final class Version20221212110541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE membre (id INT AUTO_INCREMENT NOT NULL, equip_id INT NOT NULL, nom VARCHAR(50) NOT NULL, cognoms VARCHAR(100) NOT NULL, email VARCHAR(150) NOT NULL, imatge_perfil VARCHAR(255) NOT NULL, data_naixement DATE NOT NULL, nota NUMERIC(2, 0) DEFAULT NULL, INDEX IDX_F6B4FB298AC49FD9 (equip_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
